  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const { error } = await supabase.auth.signInWithOAuth({
        provider: 'google',
        options: {
          // Redireciona para o dashboard após o Google autorizar
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        <button
          ...
          type="button"
          className="w-full bg-white hover:bg-slate-200 text-slate-900 font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-3 mb-6"
        >
          {/* Ícone SVG do Google Oficial */}
